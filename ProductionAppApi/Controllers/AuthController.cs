...
namespace ProductionAppApi.Controllers
{
	...
	public class AuthController : ControllerBase
	{
		...
		public async Task<IActionResult> ActivateUserAccount(ActivateAccountDto activateAccountDto)
		{
		...
		public async Task<IActionResult> Login([FromBody] LoginDto userData)
		{
			...
			return Ok(new ServiceResponse<string> { Data = token, Message = $"Hello {userData.Username}" });
		}
